...
public class ManagerDashboardActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private AppCompatButton buttonAddUser;
    private AppCompatButton buttonAddUserType;
    private AppCompatButton buttonAddCustomer;
    private AppCompatButton buttonAddCustomerInformation;
    private AppCompatButton buttonReportUserWise;
    private AppCompatButton buttonKmReport;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAddUser=findViewById(R.id.button_manager_dashboard_add_user);
        buttonAddUser.setOnClickListener(this);

        buttonAddUserType=findViewById(R.id.button_manager_dashboard_add_user_type);
        buttonAddUserType.setOnClickListener(this);

        buttonAddCustomer=findViewById(R.id.button_manager_dashboard_add_customer);
        buttonAddCustomer.setOnClickListener(this);

        buttonAddCustomerInformation=findViewById(R.id.button_manager_dashboard_add_customer_information);
        buttonAddCustomerInformation.setOnClickListener(this);

        buttonReportUserWise = findViewById(R.id.button_manager_dashboard_report_user_wise);
        buttonReportUserWise.setOnClickListener(this);

        buttonKmReport = findViewById(R.id.button_manager_dashboard_km_report);
...
//            Toast.makeText(getApplicationContext(),"Tracking Started",Toast.LENGTH_LONG).show();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.button_manager_dashboard_add_user:{
                startActivity(new Intent(this, RegistrationActivity.class));
                break;
            }
            case R.id.button_manager_dashboard_add_customer:{
                startActivity(new Intent(this, CustomerMasterActivity.class));
                break;
            }
            case R.id.button_manager_dashboard_add_customer_information:{
                startActivity(new Intent(this, AddCustomerInformationActivity.class));
                break;
            }
            case R.id.button_manager_dashboard_add_user_type:{
                startActivity(new Intent(this, UserTypeActivity.class));
                break;
            }

            case R.id.button_manager_dashboard_report_user_wise:{
                startActivity(new Intent(this, ReportUserWiseActivity.class));
                break;
            }
            case R.id.button_manager_dashboard_km_report:{
